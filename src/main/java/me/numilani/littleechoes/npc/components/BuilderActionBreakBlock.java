...
public class BuilderActionBreakBlock extends BuilderActionBase {
   ...
   public Action build(@Nonnull BuilderSupport builderSupport) {
      return new ActionBreakBlock(this, builderSupport);
   }
   ...
   @Nonnull
   public BuilderActionBreakBlock readConfig(@Nonnull JsonElement data) {
      this.getDouble(
         data,
         "Range",
         this.range,
